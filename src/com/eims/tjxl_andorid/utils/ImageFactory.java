...
public class ImageFactory {
	...
	/**
	 * Get bitmap from specified image path 通过路径获取Bitmap图片
	 * 
	 * @param imgPath
	 * @return
	 */
	...
	/**
	 * Store bitmap into specified image path 图像存储到指定的路径
	 * 
	 * @param bitmap
	 * @param outPath
	...
	public Bitmap ratio(String imgPath, float pixelW, float pixelH) {
		...
		newOpts.inPreferredConfig = Config.RGB_565;// 使用RGB_565
													// 代表8位RGB位图，位图数越高，即压缩时图月逼真
													// 清晰
	...
	/**
	 * Compress by quality, and generate image to the path specified 压缩图片在质量
	 * 指定路径生成图像
	 * 
	 * @param image
	 * @param outPath
