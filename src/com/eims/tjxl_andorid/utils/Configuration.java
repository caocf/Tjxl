...
public class Configuration {
	...
	public static class Builder {
		 ...
		 *            The resource identifier for the animation that's being
		 *            shown when the {@link Crouton} is going to be displayed.
		 * 
		 * @return the {@link Builder}.
		 */
		 ...
		 *            The resource identifier for the animation that's being
		 *            shown when the {@link Crouton} is going to be removed.
		 * 
		 * @return the {@link Builder}.
		 */
	...
	public String toString() {
		return "Configuration{" + "durationInMilliseconds="
				+ durationInMilliseconds + ", inAnimationResId="
