...
public class BitmapUtils {
    ...
    public static Bitmap showimageHalf(String ImagePath, int w, int h){
    	return showimageFull(ImagePath, w/2, h/2);
    }
...
//        widthRatio = (int) Math.ceil(options.outWidth / (float) w);
        //缩小图片
        heightRatio = (int) Math.ceil(options.outHeight / h);
        widthRatio = (int) Math.ceil(options.outWidth / w);
