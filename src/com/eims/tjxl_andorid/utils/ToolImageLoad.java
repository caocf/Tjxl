 ...
 *
 */
public abstract class ToolImageLoad {
	 ...
	 * 初始化ImageLoader
	 */
	public static ImageLoader initImageLoader(Context context,String cachePath) {
		// 获取到缓存的目录地址
		File cacheDir = StorageUtils.getOwnCacheDirectory(context,"/tjxl/cache/ImageCache");
		System.out.println("图片文件缓存目录："+cacheDir);
		...
		.discCacheFileCount(200)// 缓存的File数量
