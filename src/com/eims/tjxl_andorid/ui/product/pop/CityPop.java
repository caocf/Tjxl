...
public class CityPop {
	...
	ImageView back;
	public CityPop(Activity content,int type,List<City> provinceList){
	...
	private void initListView(){
		...
		if(mAdapter==null){
			mAdapter=new CityAdapter(provinceList, content);
		}
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int postion,
					long arg3) {
				City bean = (City) parent.getAdapter().getItem(postion);
