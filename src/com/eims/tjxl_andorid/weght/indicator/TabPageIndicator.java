 ...
 */
package com.eims.tjxl_andorid.weght.indicator;
...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	public interface OnTabReselectedListener {
		 ...
		 */
		void onTabReselected(int position, boolean sort_state);
	}
	...
	private class TabView extends TextView {
		private int mIndex;
		private boolean state = true; // 状态 正序：true；反序 ：false
	...
	public TextView getChildTextView(int position) {
		return (TextView) mTabLayout.getChildAt(position);
	}

	private OnMyPagerChangeListener mylistener;

	public void setOnMyPagerChangeListener(OnMyPagerChangeListener mylistener) {
