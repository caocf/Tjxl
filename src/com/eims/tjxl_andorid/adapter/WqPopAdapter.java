...
public class WqPopAdapter extends BaseAdapter {

	private int mPosition;
	private List<WqType> mItems;
	private WqPopupWindow mWindow;
	// private SerachActivity mActivity;
	private Context context;
	private onItemClickListener mListener;

	public WqPopAdapter(WqPopupWindow window, Context context,
			List<WqType> items) {
	...
	public View getView(final int arg0, final View arg1, ViewGroup arg2) {
		...
		holder.text.setText(mItems.get(arg0).type_name);
